                    ...
                    <div class="col-12">
                        ...
                        <div class="card">
                            <div class="card-header">
                                <a href="form_periksa.php"><button class="btn btn-primary mb-1">Tambah Data</button></a>
                                <table class="table">
                                    <thead>
                                        <tr>
                                            <th>No</th>
                                    ...
                                    <tbody>
                                        ...
                                        foreach ($query as $row) {
                                            ...
                                            echo "<td><a href='delete_pemeriksaan.php?id=" . $row['id'] . "' class='btn btn-danger btn-sm'>Delete</a></td>";
                                            echo "<td><a href='update_pemeriksaan.php?id=" . $row['id'] . "' class='btn btn-primary btn-sm'>Update</a></td>";
                                            echo "</tr>";
                                        }
                                        ?>
                                    </tbody>
