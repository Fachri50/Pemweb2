                                ...
                                <table class="table">
                                    ...
                                    <tbody>
                                        ...
                                        foreach ($query as $row) {
                                            ...
                                            echo "<td><a href='delete_pasien.php?id=" . $row['id'] . "' class='btn btn-danger btn-sm'>Delete</a></td>";
                                            echo "<td><a href='update_pasien.php?id=" . $row['id'] . "' class='btn btn-primary btn-sm'>Update</a></td>";
                                            echo "</tr>";
