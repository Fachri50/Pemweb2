...
<head>
    ...
    <title>Centres De Santé Communautaire</title>
    ...
    <div class="wrapper">
        ...
        <nav class="main-header navbar navbar-expand navbar-white navbar-light">
            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item d-none d-sm-inline-block">
                    <a href="data_kelurahan.php" class="nav-link">Data Kelurahan</a>
                </li>
                <li class="nav-item d-none d-sm-inline-block">
                    <a href="data_unit_kerja.php" class="nav-link">Data Unit Kerja</a>
                </li>
            </ul>
